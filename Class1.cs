...
#warning 这里忘记在哪触发了，没修
                else if (data.ContainsKey("user_info_summary") && (data["user_info_summary"].ContainsKey("user_trained_chara") || data["user_info_summary"].ContainsKey("user_trained_chara_array")))
